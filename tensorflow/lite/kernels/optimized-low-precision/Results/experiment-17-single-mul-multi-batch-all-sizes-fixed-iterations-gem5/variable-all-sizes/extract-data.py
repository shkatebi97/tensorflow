...
for result_method_dir in result_methods_dirs:
    ...
    for size_tuple in sizes:
        ...
        with open(join(dir_name, f"model-{size_string}", "stats.txt")) as stat_f:
            ...
            LLDCacheAccess       = stats['system.l2.overall_accesses::.cpu.data']
            LLDCacheMisses       = stats['system.l2.overall_misses::.cpu.data']
            LLDCacheMissRate     = stats['system.l2.overall_miss_rate::.cpu.data']
    ...
    for metric in metrics:
        if 'cpu_cycles' == metric:
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("cpu_cycles") * (n_r + 2) + (i + 3), metrics_order.index("cpu_cycles") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append(('Kernel cpu_cycles reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 0 * (n_r + 2) + (i + 3), metrics_order.index('cpu_cycles_kernel_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            ...
            extras.append(('Method cpu_cycles reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 0 * (n_r + 2) + (i + 3), metrics_order.index('cpu_cycles_method_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'cpu_cycles_pack_share' == metric:
            extras.append(('Pack cpu_cycles Reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 0 * (n_r + 2) + (i + 3), metrics_order.index('cpu_cycles_pack_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'instructions' == metric:
            extras.append((
                'Instructions reduction against I8-I8', 
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("instructions") * (n_r + 2) + (i + 3), metrics_order.index("instructions") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append(('Kernel instructions reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 1 * (n_r + 2) + (i + 3), metrics_order.index('instructions_kernel_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'instructions_method_share' == metric:
            extras.append(('Method instructions reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 1 * (n_r + 2) + (i + 3), metrics_order.index('instructions_method_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'instructions_pack_share' == metric:
            extras.append(('Pack instructions Reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 1 * (n_r + 2) + (i + 3), metrics_order.index('instructions_pack_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'l1d_loads' == metric:
            extras.append((
                'L1 Data Cache Loads reduction against I8-I8', 
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("l1d_loads") * (n_r + 2) + (i + 3), metrics_order.index("l1d_loads") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append(('Kernel l1d_loads reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 2 * (n_r + 2) + (i + 3), metrics_order.index('l1d_loads_kernel_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'l1d_loads_method_share' == metric:
            extras.append(('Method l1d_loads reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 2 * (n_r + 2) + (i + 3), metrics_order.index('l1d_loads_method_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'l1d_loads_pack_share' == metric:
            extras.append(('Pack l1d_loads Reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 2 * (n_r + 2) + (i + 3), metrics_order.index('l1d_loads_pack_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'l1d_misses' == metric:
            extras.append((
                'L1 Data Cache Load Misses reduction against I8-I8', 
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("l1d_misses") * (n_r + 2) + (i + 3), metrics_order.index("l1d_misses") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append(('Kernel l1d_misses reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 3 * (n_r + 2) + (i + 3), metrics_order.index('l1d_misses_kernel_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'l1d_misses_method_share' == metric:
            extras.append(('Method l1d_misses reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 3 * (n_r + 2) + (i + 3), metrics_order.index('l1d_misses_method_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'l1d_misses_pack_share' == metric:
            extras.append(('Pack l1d_misses Reduction against I8-I8', lambda k, i, j, n_t, n_r, n_c: method_based_decrease_kernel_share_based_on_basline_str.format(chr(66 + j).upper(), 3 * (n_r + 2) + (i + 3), metrics_order.index('l1d_misses_pack_share') * (n_r + 2) + (i + 3), 'I8_I8')))
            transforms.append(lambda x: x)
            transform_wrong_datas.append(lambda x: x if x != 0 else 0.00001)
        elif 'IPC' == metric:
            extras.append((
                'IPC increase against I8-I8', 
                lambda k, i, j, n_t, n_r, n_c: method_based_increase_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("IPC") * (n_r + 2) + (i + 3), metrics_order.index("IPC") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("L1DCacheMissRate") * (n_r + 2) + (i + 3), metrics_order.index("L1DCacheMissRate") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("LLDCacheAccess") * (n_r + 2) + (i + 3), metrics_order.index("LLDCacheAccess") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("LLDCacheMisses") * (n_r + 2) + (i + 3), metrics_order.index("LLDCacheMisses") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("LLDCacheMissRate") * (n_r + 2) + (i + 3), metrics_order.index("LLDCacheMissRate") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_order.index("time_total") * (n_r + 2) + (i + 3), metrics_order.index("time_total") * (n_r + 2) + (i + 3), 'I8_I8'),
