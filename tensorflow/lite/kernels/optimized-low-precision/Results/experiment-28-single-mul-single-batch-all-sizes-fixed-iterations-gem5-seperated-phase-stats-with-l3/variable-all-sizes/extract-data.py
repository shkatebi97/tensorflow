...
for result_method_dir in result_methods_dirs:
    ...
    for size_tuple in sizes:
        ...
        with open(join(dir_name, f"model-{size_string}", "stats.txt")) as stat_f:
            ...
            L2DCacheAccess      = stats['system.l2.overall_accesses::.cpu.data'] if 'system.l2.overall_accesses::.cpu.data' in stats else 0 # 1
            L2DCacheMisses      = stats['system.l2.overall_misses::.cpu.data'] if 'system.l2.overall_misses::.cpu.data' in stats else 0 # 1
            L2DCacheMissRate    = stats['system.l2.overall_miss_rate::.cpu.data'] if 'system.l2.overall_miss_rate::.cpu.data' in stats else 0 # 0.001
            L2DCacheMissLatency = stats['system.l2.overall_miss_latency::.cpu.data'] if 'system.l2.overall_miss_latency::.cpu.data' in stats else 0 # 0.001

            L2ICacheAccess      = stats['system.l2.overall_accesses::.cpu.inst'] if 'system.l2.overall_accesses::.cpu.inst' in stats else 0 # 1
            L2ICacheMisses      = stats['system.l2.overall_misses::.cpu.inst'] if 'system.l2.overall_misses::.cpu.inst' in stats else 0 # 1
            L2ICacheMissRate    = stats['system.l2.overall_miss_rate::.cpu.inst'] if 'system.l2.overall_miss_rate::.cpu.inst' in stats else 0 # 0.001

            LLDCacheAccess      = stats['system.l3.overall_accesses::.cpu.data'] if 'system.l3.overall_accesses::.cpu.data' in stats else 0 # 1
            LLDCacheMisses      = stats['system.l3.overall_misses::.cpu.data'] if 'system.l3.overall_misses::.cpu.data' in stats else 0 # 1
            LLDCacheMissRate    = stats['system.l3.overall_miss_rate::.cpu.data'] if 'system.l3.overall_miss_rate::.cpu.data' in stats else 0 # 0.001
            LLDCacheMissLatency = stats['system.l3.overall_miss_latency::.cpu.data'] if 'system.l3.overall_miss_latency::.cpu.data' in stats else 0 # 0.001

            LLICacheAccess      = stats['system.l3.overall_accesses::.cpu.inst'] if 'system.l3.overall_accesses::.cpu.inst' in stats else 0 # 1
            LLICacheMisses      = stats['system.l3.overall_misses::.cpu.inst'] if 'system.l3.overall_misses::.cpu.inst' in stats else 0 # 1
            LLICacheMissRate    = stats['system.l3.overall_miss_rate::.cpu.inst'] if 'system.l3.overall_miss_rate::.cpu.inst' in stats else 0 # 0.001
    ...
    for metric in metrics:
        if 'CPUCycles' == metric:
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2DCacheAccess") * (n_r + 2) + (i + 3), metrics_sorted.index("L2DCacheAccess") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2DCacheMisses") * (n_r + 2) + (i + 3), metrics_sorted.index("L2DCacheMisses") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2DCacheMissRate") * (n_r + 2) + (i + 3), metrics_sorted.index("L2DCacheMissRate") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2DCacheMissLatency") * (n_r + 2) + (i + 3), metrics_sorted.index("L2DCacheMissLatency") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2ICacheAccess") * (n_r + 2) + (i + 3), metrics_sorted.index("L2ICacheAccess") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2ICacheMisses") * (n_r + 2) + (i + 3), metrics_sorted.index("L2ICacheMisses") * (n_r + 2) + (i + 3), 'I8_I8'),
            ...
            extras.append((
                ...
                lambda k, i, j, n_t, n_r, n_c: method_based_decrease_based_on_basline_str.format(chr(66 + j).upper(), metrics_sorted.index("L2ICacheMissRate") * (n_r + 2) + (i + 3), metrics_sorted.index("L2ICacheMissRate") * (n_r + 2) + (i + 3), 'I8_I8'),
