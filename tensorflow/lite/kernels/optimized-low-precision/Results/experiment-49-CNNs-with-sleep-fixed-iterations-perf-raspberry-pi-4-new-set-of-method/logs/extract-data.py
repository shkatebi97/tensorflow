...
functions = {
    ...
    "Overall": {
        ...
        "BarrelShift-Mul-W8A8": "tflite::Subgraph::OpInvoke",
    ...
    "Conv": {
        ...
        "Overall": {
            ...
            "BarrelShift-Mul-W8A8": "tflite::ops::builtin::conv::Eval<(tflite::ops::builtin::conv::KernelType)1>",
        ...
        "GEMM": {
            ...
            "Overall": {
                ...
                "BarrelShift-Mul-W8A8": "tflite::ops::builtin::conv::EvalQuantizedPerChannel<(tflite::ops::builtin::conv::KernelType)1>",
            ...
            #     "BarrelShift-Mul-W8A8": "LowPrecision::FullyConnected::Mul",
            ...
            "Kernel": {
                ...
                "Overall": {
                    ...
                    "BarrelShift-Mul-W8A8": "LowPrecision::GEMM",
            ...
            "Packing": {
                ...
                "Overall": {
                    ...
                    "BarrelShift-Mul-W8A8": "LowPrecision::PrepareMatrixAsInputForMethod",
        ...
        "Others": {
            ...
            "Overall": {
                ...
                "BarrelShift-Mul-W8A8": "tflite::optimized_ops::Im2col<signed char>",
