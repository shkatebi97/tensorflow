...
if options.output != sys.stdout:
    ...
    print_as_csv("CNNsFCs-ImageNet-1K", "Models", methods, models_names_1K_imagenet, results, open(imagenet_1K_csv_path, "w"))
    print_as_csv("CNNsFCs-ImageNet-21K", "Models", methods, models_names_21K_imagenet, results, open(imagenet_21K_csv_path, "w"))
    if options.speedups:
        ...
        print_as_csv_wrt_baseline("CNNsFCs-ImageNet-1K", "Models", methods, models_names_1K_imagenet, results, "I8-I8", open(speedup_imagenet_1K_csv_path, "w"))
        print_as_csv_wrt_baseline("CNNsFCs-ImageNet-21K", "Models", methods, models_names_21K_imagenet, results, "I8-I8", open(speedup_imagenet_21K_csv_path, "w"))
else:
    print_as_csv("CNNsFCs-ImageNet-1K", "Models", methods, models_names_1K_imagenet, results)
    print_as_csv("CNNsFCs-ImageNet-21K", "Models", methods, models_names_21K_imagenet, results)
    print_as_csv_wrt_baseline("CNNsFCs-ImageNet-1K", "Models", methods, models_names_1K_imagenet, results, "I8-I8", open(join("CSVs", "speedups-imagenet-1K.csv"), "w"))
    print_as_csv_wrt_baseline("CNNsFCs-ImageNet-21K", "Models", methods, models_names_21K_imagenet, results, "I8-I8", open(join("CSVs", "speedups-imagenet-21K.csv"), "w"))
exit(0)
