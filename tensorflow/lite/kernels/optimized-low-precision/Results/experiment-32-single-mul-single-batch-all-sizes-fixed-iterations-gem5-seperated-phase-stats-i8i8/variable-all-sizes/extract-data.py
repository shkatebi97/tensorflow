...
extras = [
    ...
    lambda k, i, j, n_t, n_r, n_c: decrease_based_on_basline_str.format(num_column_to_spreadsheet_letter(1 + j).upper(), methods_order.index("Binary-Binary-XOR") * (n_r + 2) + (i + 3), k * (n_r + 2) + (i + 3)),
]
extras_values = [
    ...
    lambda c, x, y, method: method_based_decrease_based_on_basline_val(results, c, x, y, method, 'Binary-Binary-XOR'),
]
extras_titles = [
...
extras_values = [
    ...
    lambda c, x, y, method: method_based_decrease_based_on_basline_val(metrics_values['CPUCycles'], c, x, y, method, 'Binary-Binary-XOR'),
]
extras_titles = [
    "Speed-up against I8-I8",
    "Speed-up against XNNPack",
