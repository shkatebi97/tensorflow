            ...
            Status MultiplyInt8MultiBatched(
                ...
                */
                asm volatile(
                    ...
                    "shl v8.16b,  v4.16b,  #4\n\t"
                    "shl v9.16b,  v5.16b,  #4\n\t"
                    "shl v10.16b, v6.16b, #4\n\t"
                    "shl v11.16b, v7.16b, #4\n\t"
                    ...
                    // Activation Row #4
                    // SMULL MiniACC, W, AH[3]
                    "smull v12.8h, v0.8b, v7.8b\n\t"
                    "smull v13.8h, v1.8b, v7.8b\n\t"
                    "smull v14.8h, v2.8b, v7.8b\n\t"
                    "smull v15.8h, v3.8b, v7.8b\n\t"

                    // SMLAL2 MiniACC, W, AH[3]
